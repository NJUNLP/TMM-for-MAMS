...
class RobertaHubInterface(nn.Module):
    ...
    def extract_features(self, tokens: torch.LongTensor, return_all_hiddens: bool = False,get_attention_weights=False) -> torch.Tensor:
        if tokens.dim() == 1:
        ...
        if get_attention_weights:
            return features,extra['attention_weights']
